# Function to log messages
      ...
      curl https://raw.githubusercontent.com/helm/helm/main/scripts/get-helm-3 | bash || {
          echo "[ERROR] Helm installation failed. Exiting."
          exit 1
      }
      ...
      helm version || {
          echo "[ERROR] Helm installation verification failed. Exiting."
          exit 1
      }

      log "Installation of Docker, Kubernetes tools, and Helm complete!"
